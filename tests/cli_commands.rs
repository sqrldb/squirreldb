...
// =============================================================================
// UsersAction Tests (Structural)
// =============================================================================

use squirreldb::client::UsersAction;

#[test]
fn test_users_action_list_variant() {
  let action = UsersAction::List;
  matches!(action, UsersAction::List);
}

#[test]
fn test_users_action_add_variant() {
  let action = UsersAction::Add {
    username: "testuser".to_string(),
    password: Some("secret".to_string()),
    superuser: false,
    createdb: true,
  };
  if let UsersAction::Add {
    username,
    password,
    superuser,
    createdb,
...
#[test]
fn test_users_action_remove_variant() {
  let action = UsersAction::Remove {
    username: "olduser".to_string(),
  };
  if let UsersAction::Remove { username } = action {
...
#[test]
fn test_users_action_passwd_variant() {
  let action = UsersAction::Passwd {
    username: "user".to_string(),
    password: None,
  };
  if let UsersAction::Passwd { username, password } = action {
