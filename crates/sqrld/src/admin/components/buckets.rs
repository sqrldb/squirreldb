              ...
              <tbody>
                <For
                  ...
                  children=move |bucket| {
                    let bucket_name_view = bucket.name.clone();
                    ...
                    view! {
                      <tr>
                        ...
                        <td class="actions">
                          <ViewBucketButton name=bucket_name_view/>
...
#[component]
fn ViewBucketButton(name: String) -> impl IntoView {
  ...
  view! {
    <button
      ...
      on:click=move |_| {
        let path = format!("/buckets/{}", name_clone);
